...
***********************************************************************/
extern int addTransPolicy( FILE *fh, char *subj_level, char *obj_level, char* new_level, int op, int ttype );
...
***********************************************************************/
extern int matchLevelName( element *e, void *obj );
extern int matchMapName( element *e, void *obj );
extern int matchLevel( element *e, void *obj );
extern int matchTrans( element *e, void *obj );